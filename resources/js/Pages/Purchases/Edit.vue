                      ...
                      <form @submit.prevent="updatePurchase(form.id)">
                        ...
                        <div class="lg:w-1/2 md:w-2/3 mx-auto">
                          ...
                          <table class="table-auto w-full text-left whitespace-no-wrap">
                            ...
                            <div class="p-2 w-full">
                              <div class="relative">
                                <label class="leading-7 text-sm text-gray-600 mr-4">ステータス</label>
                                <input type="radio" id="status_on" name="status" value="1" v-model="form.status"/>
                                <label for="status_on" class="ml-2 mr-4">未キャンセル</label>   
                                <input type="radio" id="status_drop" name="status" value="0" v-model="form.status"/> 
                                <label for="status_drop" class="ml-2 mr-4">キャンセルする</label>  
                              </div>
                            </div>
